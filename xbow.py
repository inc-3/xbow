...
def S2():
	...
	fbcr = "random.choice(['o2 - de', 'Verizon - us', 'Vodafone - uk','null','en_GB','en_US','en_PK','IND airtel','Nepal Telecom'])}"
	s = "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = '[FBAN/FB4A;FBAV/315.0.0.42.122;FBBV/960213045;FBDM/{density=2.8,width=720,height=1520};FBLC/fr_FR;FBRV/960213045;FBCR/Orange;FBMF/Huawei;FBBD/Huawei;FBPN/com.facebook.katana;FBDV/P30 Lite;FBSV/10.0.0;FBOP/1;FBCA/arm64-v8a:armeabi-v7a;]'
	ua = s + e
	#print(ua)
	return ua 
