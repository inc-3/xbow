...
def S2():
	...
	fbcr = "random.choice(['o2 - de', 'Verizon - us', 'Vodafone - uk','null','en_GB','en_US','en_PK','IND airtel','Nepal Telecom'])}"
	s = "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = '[FBAN/FB4A;FBAV/270.0.0.49.127;FBBV/790112014;FBDM/{density=2.5,width=720,height=1600};FBLC/en_US;FBRV/790112014;FBCR/Robi;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2269;FBSV/10.0.0;FBOP/1;FBCA/arm64-v8a:armeabi-v7a;]'
	ua = s + e
	#print(ua)
	return ua 
