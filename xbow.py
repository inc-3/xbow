...
def S2():
	...
	fbcr = "random.choice(['o2 - de', 'Verizon - us', 'Vodafone - uk','null','en_GB','en_US','en_PK','IND airtel','Nepal Telecom'])}"
	s = "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = '[FBAN/FB4A;FBAV/335.0.0.41.124;FBBV/920303218;FBDM/{density=2.75,width=1080,height=2408};FBLC/en_US;FBRV/920303218;FBCR/Banglalink;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/RMX3511;FBSV/12.0.0;FBOP/1;FBCA/arm64-v8a:armeabi-v7a;]'
	ua = s + e
	#print(ua)
	return ua 
